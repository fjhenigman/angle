...

{
    'variables':
    {
        ...
        [
            ...
            '<(spirv_tools_path)/source/val/BasicBlock.cpp',
            ...
            '<(spirv_tools_path)/source/val/ValidationState.cpp',
        ],
                    ...
                    [
                        {
                            ...
                            'inputs':
                            [
                                '<(vulkan_layers_path)/scripts/vk-generate.py',
                                '<(vulkan_layers_path)/scripts/vulkan.py'
                            ],
                            'outputs':
                            [
                            ...
                            'action':
                            [
                                'python', '<(vulkan_layers_path)/scripts/vk-generate.py', '<(vulkan_wsi)',
                                'dispatch-table-ops', 'layer', '<(angle_gen_path)/vulkan/vk_dispatch_table_helper.h',
                            ],
                        },
                        {
                    ...
                    [
                        {
                            ...
                            'action':
                            [
                                'python', '<(vulkan_layers_path)/scripts/vk-generate.py', 'Win32',
                                'win-def-file', 'VkLayer_<(RULE_INPUT_ROOT)', 'layer',
                                '<(angle_gen_path)/vulkan/VkLayer_<(RULE_INPUT_ROOT).def',
                            ],
                        },
                    ],
                    ...
                    [
                        {
                            ...
                            [
                                'python', '<(vulkan_layers_path)/scripts/vk-generate.py', 'Win32',
                                'win-def-file', 'VkLayer_parameter_validation', 'layer',
                                '<(angle_gen_path)/vulkan/VkLayer_parameter_validation.def',
                            ],
                        },
                    ],
                    ...
                    [
                        {
                            ...
                            [
                                ...
                                '-registry', '<(vulkan_layers_path)/scripts/vk.xml', 'unique_objects_wrappers.h',
                            ],
                        },
                    ],
                },
                    ...
                    [
                        {
                            ...
                            [
                                'python', '<(vulkan_layers_path)/scripts/lvl_genvk.py', '-o', '<(angle_gen_path)/vulkan',
                                '-registry', '<(vulkan_layers_path)/scripts/vk.xml', 'parameter_validation.h',
                            ],
                        },
                    ],
                },
